...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By M UDHAY KUMAR",
                #    page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *M UDHAY KUMAR*!"""})
...
def setting_bg():
    ...
    # Apply the background styling using HTML and CSS
    st.markdown(
        f"""
        <style>
            body {{
    ...
    st.write("This is a Streamlit app with a dark theme.")
setting_bg()
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"C:\Users\udhay\OneDrive\Desktop\New folder\main.jpg"),width=500)
